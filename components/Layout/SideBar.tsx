...
const SideBar = () => {
  ...
  return (
    <div className="fixed z-50 w-[300px] border-r-2 border-r-[#AFAFAF] h-full">
      <div className="p-4 flex flex-col items-center text-center">
        <h1 className="text-[40px] font-bold text-[#1CB0F6]">6th Element</h1>
        <div className="pt-6 flex flex-col gap-6">
          <Link
            href="/dashboard/learn"
            className={`${
              pathName === "/dashboard/learn"
                ? "text-[22px] font-bold flex items-center gap-4 border border-[#1CB0F6] p-2 px-4 rounded-xl  text-[#1CB0F6] bg-[#DDF4FF] w-[240px]"
