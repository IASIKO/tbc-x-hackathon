...
const SideBar = () => {
  ...
  return (
    <div className="fixed z-50 xl:w-[300px] w-auto border-r-2  h-full">
      <div className="p-4 flex flex-col items-center text-center">
        ...
        <div className="pt-6 flex flex-col gap-6">
          ...
          <div
            ...
            className="text-[22px] font-bold text-[#777777] flex justify-center xl:justify-start items-center gap-4 relative cursor-pointer"
          >
            <Image src={othersIcon} alt="Others icon" className="w-12 h-12" />{" "}
            <span className="hidden xl:block">Others</span>
            {otherModal && (
              <div className="absolute top-16 left-2 xl:left-0 w-[240px] flex flex-col gap-4 border border-[#1CB0F6] bg-[#DDF4FF] rounded p-4">
                <Link
